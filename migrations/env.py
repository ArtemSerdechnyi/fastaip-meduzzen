...
from app.services.postgres import PostgresDB
...
config.set_section_option(section, "DB_NAME", _pg_conf.POSTGRES_DB)
config.set_section_option(section, "DB_PASS", _pg_conf.POSTGRES_PASSWORD)
